...
```
Targets IP `192.168.1.x` (hardcoded in `platformio.ini`). Update `upload_port` if device IP changes.
...
**Fixes**:
1. Verify device is on WiFi: `ping 192.168.1.x`
